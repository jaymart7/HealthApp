...
import ph.mart.healthapp.feature.food.ui.AddEntryForm
import ph.mart.healthapp.feature.food.ui.isValid

/**
 * The barcode flow's review step. Same parts as [ConfirmationScreen] minus the photo and the AI
