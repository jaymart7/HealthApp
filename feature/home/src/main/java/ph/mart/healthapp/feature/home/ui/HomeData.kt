 ...
 *
 * The screen does not read this: Home draws its cards from the first launch, because the cards
 * *are* the invitation on an empty day. The one caller is `requestInsight()`, which will not ask
 * the model about a day with nothing in it.
 *
