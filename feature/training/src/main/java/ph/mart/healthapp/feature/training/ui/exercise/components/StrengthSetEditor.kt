...
internal fun StrengthSetEditor(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(12.dp), modifier = modifier) {
        AppTextField(
            ...
            placeholder = stringResource(R.string.training_strength_exercise_placeholder),
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.fillMaxWidth()) {
            NumericStepperField(
                label = stringResource(R.string.training_strength_reps),
                value = "${draft.reps}",
                unitSuffix = "",
            ...
            NumericStepperField(
                ...
                label = stringResource(
                    if (draft.weightKg <= 0.0) R.string.training_strength_load_bodyweight else R.string.training_strength_load,
                ),
